        .text
        .globl ushl_count_boundaries
        .p2align 2
        .type ushl_count_boundaries,@function
ushl_count_boundaries:
        movz x1, #32387
        ...
        fmov x1, d0
        movz x3, #0
        movk x3, #32321, lsl #32
        movk x3, #6, lsl #48
        eor x1, x1, x3
        ext v0.16b, v0.16b, v0.16b, #8
        fmov x2, d0
        movz x3, #0
        movk x3, #16129, lsl #48
        eor x2, x2, x3
        orr x0, x1, x2
        ret
        .size ushl_count_boundaries, .-ushl_count_boundaries
